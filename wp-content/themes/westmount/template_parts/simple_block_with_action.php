<?php if ( ! get_field( 'hide_block', $page_id ) ): ?>
    ...
    <section class="section_home_surety"
	         ...
	         <?php endif; ?>
                     background-image: radial-gradient(59.53% 53.31% at 78.15% 42.3%, <?php echo $color_bg1; ?> 15.62%, <?php echo $color_bg2; ?> 100%);
                     background-position: center;
                     background-repeat: no-repeat;
                     background-size: cover;
                     min-height: <?php echo get_sub_field( 'height_block' ); ?>px"
    >
        ...
        <div class="container">
            <div class="height_wrap"
                 style="min-height: <?php echo get_sub_field( 'height_block' ) * 0.85; ?>px">
